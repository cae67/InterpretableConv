...
class MyHyperModel(kt.HyperModel):
    ...
    def build(self,hp):
        ...
        x = BatchNormalization()(x)
        x = Dense(hp.Int("dense_units", min_value=10, max_value=20, step=2),activation='relu')(x)
...
tuner = CVTuner(
    ...
    project_name="Keras_tuner_logs_M2_v3")
...
results_filename = "/data/users3/cellis42/Spectral_Explainability/InterpretableConv/Performance_M2v3_kt.mat"
